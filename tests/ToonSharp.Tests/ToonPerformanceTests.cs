...
public class ToonPerformanceTests
{
    ...
    [Fact]
    public void Memory_MultipleEncodeDecode_NoLeaks()
    {
        // Arrange
        var data = new
        {
        ...
        // Assert: La memoria non dovrebbe crescere significativamente
        var memoryGrowth = endMemory - startMemory;
        _output.WriteLine($"Memory growth after 100 iterations: {memoryGrowth / 1024}KB");

        // Crescita dovrebbe essere < 10MB
