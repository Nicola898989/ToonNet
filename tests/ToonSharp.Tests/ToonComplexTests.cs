...
public class ToonComplexTests
{
    ...
    public void RoundTrip_LargeDataset_PreservesAllData()
    {
        ...
        var toon = ToonSharp.Encode(data);
        var result = ToonSharp.Decode<CompanyDataset>(toon);
    ...
    public void Encode_DeeplyNestedObject_ReturnsCorrectStructure()
    {
        ...
        // Round-trip test
        var roundTrip = ToonSharp.Decode<LevelOne>(toon);
    ...
    public void Encode_MixedComplexStructure_HandlesCorrectly()
    {
        ...
        // Round-trip
        var result = ToonSharp.Decode<ComplexDocument>(toon);
        Assert.NotNull(result);
    ...
    public void RoundTrip_MultiLayeredConfiguration_PreservesDeepStructure()
    {
        ...
        // Act
        var toon = ToonSharp.Encode(data);
        var decoded = ToonSharp.Decode<SystemTopology>(toon);
    ...
    public void RoundTrip_KeyFoldedTelemetry_PreservesExpandedStructure()
    {
        ...
        // Act
        var toon = ToonSharp.Encode(telemetry, encodeOptions);
        ...
        var result = ToonSharp.Decode(toon, decodeOptions);
    ...
    public void Encode_WithKeyFolding_CollapsesNestedStructure()
    {
        ...
        // Act
        var toon = ToonSharp.Encode(data, options);
        ...
        var result = ToonSharp.Decode<ApiDocument>(toon, decodeOptions);
    ...
    public void Encode_LargeTabularDataWithTabDelimiter_MoreEfficient()
    {
        ...
        // Act
        var toonComma = ToonSharp.Encode(data, optionsComma);
        var toonTab = ToonSharp.Encode(data, optionsTab);
        ...
        var result = ToonSharp.Decode<TransactionBatch>(toonTab);
        Assert.NotNull(result);
    ...
    public void Encode_ArrayOfArrays_HandlesCorrectly()
    {
        ...
        // Round-trip
        var result = ToonSharp.Decode(toon);
        var obj = result?.AsObject();
        Assert.NotNull(obj);
    ...
    public void Encode_SpecialCharactersInStrings_QuotesAndEscapes()
    {
        ...
        // Round-trip
        var typed = ToonSharp.Decode<SpecialTextPayload>(toon);
    ...
    public void Encode_ComplexECommerceOrder_FullScenario()
    {
        ...
        // Round-trip completo
        var result = ToonSharp.Decode<OrderDocument>(toon);
        Assert.NotNull(result);
    ...
    public void Encode_WithLengthMarkerAndPipeDelimiter_CombinedOptions()
    {
        ...
        // Round-trip
        var result = ToonSharp.Decode<UserCollection>(toon);
        Assert.NotNull(result);
    ...
    public void Decode_MalformedData_StrictMode_ThrowsException()
    {
        ...
        {
            Assert.Throws<FormatException>(() => ToonSharp.Decode(toon, options));
        }
    }
    ...
    public void Encode_EmptyAndNullScenarios_HandlesGracefully()
    {
        ...
        // Round-trip
        var result = ToonSharp.Decode<NullScenario>(toon);
        Assert.NotNull(result);
    ...
    public void Encode_HugeNullableGraph_RoundTrips(int activeNodes)
    {
        ...
        var toon = ToonSharp.Encode(container);
        Assert.Contains("Node01:", toon);
        Assert.Contains("Node55:", toon);

        var roundTrip = ToonSharp.Decode<HugeNullableContainer>(toon);
        Assert.NotNull(roundTrip);
    ...
    public void RoundTrip_DeepNestedArrays_PreserveStructure(int depth)
    {
        ...
        var decoded = ToonSharp.Decode(toon);
